...
private:
    ...
    const char *feature_names[NUM_FEATURES] = {
            ...
            "RFID_MES_PACKAGES_LIST", "RFID_PACKAGE_GROUPS_LIST", "RFID_BUYER_PO_LIST", "RFID_PO_DETAILS", "PACKAGE",
            "PACKAGE_DETAILS", "CO_WORKING", "CO_WORKING_SCAN_NEARBY_DEVICE", "CO_WORKING_CONNECT_TO_DEVICE",
