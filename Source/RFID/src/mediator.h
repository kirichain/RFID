...
private:
    const char *task_names[NUM_TASKS] = {
            ...
            "SEND_SERIAL_COMMUNICATION_MESSAGE", "INIT_MESSAGE_QUEUE", "CLEAR_MESSAGE_QUEUE", "PUBLISH_MQTT_MESSAGE",
            "SUBSCRIBE_MQTT_TOPIC", "CONNECT_MQTT_BROKER", "HANDLE_MQTT_MESSAGE", "LOAD_CONFIG", "SAVE_CONFIG",
            "LOAD_FS", "SAVE_FS", "CHECK_CONNECTION", "INIT_AP_WIFI", "INIT_STA_WIFI", "TERMINATE_AP_WIFI",
            "TERMINATE_STA_WIFI", "SCAN_WIFI_NETWORKS", "GET_OPERATING_MODE", "SET_OPERATING_MODE",
            "RENDER_FEATURE", "GET_CURRENT_FEATURE", "READ_NAVIGATION_BUTTON", "INIT_NAVIGATION_BUTTON",
            "SET_CURRENT_FEATURE", "SET_TASK", "SET_TASK_STATUS", "GET_TASK_STATUS", "GET_RFID_SCAN_DATA",
            "IMPORT_DATA_FROM_SD_CARD", "IMPORT_DATA_FROM_SERVER", "EXPORT_DATA_TO_SD_CARD", "EXPORT_DATA_TO_SERVER",
            "SYNC_DATA_TO_SERVER", "SYNC_DATA_TO_DEVICE", "READ_RFID_TAG", "WRITE_RFID_TAG", "SET_RFID_SCANNING_MODE",
            "REGISTER_RFID_TAG", "INSERT_DATA_ROW", "UPDATE_DATA_ROW", "DELETE_DATA_ROW", "SAVE_DATA_COLLECTION",
            "DELETE_DATA_COLLECTION", "LOAD_DATA_COLLECTION", "READ_PERIPHERAL_INPUT", "SEND_PERIPHERAL_OUTPUT",
            "START_CONVEYOR", "STOP_CONVEYOR", "SUBMIT_CHOSEN_ITEM"
    };
    const char *feature_names[NUM_FEATURES] = {
            "BOOT", "LOADING", "QR_CODE_SCANNING", "HOME_HANDHELD_1", "HOME_HANDHELD_2", "HOME_TERMINAL", "SETUP", "SETUP_WIFI",
