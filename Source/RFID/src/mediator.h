...
private:
    const char *task_names[NUM_TASKS] = {
            ...
            "GET_TASK_STATUS", "GET_RFID_SCAN_DATA", "IMPORT_DATA_FROM_SD_CARD",
            ...
            "RESET_SCANNED_RFID_TAG_COUNT", "INSERT_DATA_ROW", "UPDATE_DATA_ROW", "DELETE_DATA_ROW", "SAVE_DATA_COLLECTION",
            "DELETE_DATA_COLLECTION", "LOAD_DATA_COLLECTION", "READ_PERIPHERAL_INPUT", "SEND_PERIPHERAL_OUTPUT",
            "START_CONVEYOR", "STOP_CONVEYOR", "SUBMIT_CHOSEN_ITEM", "NO_TASK"
    };
    const char *feature_names[NUM_FEATURES] = {
            "BOOT", "LOADING", "QR_CODE_SCANNING", "HOME_HANDHELD_1", "HOME_HANDHELD_2", "HOME_TERMINAL", "SETTING",
            "SETTING_WIFI", "SETUP_USER_INFO", "SETUP_USER_INFO_LOGIN", "SETUP_USER_INFO_LOGOUT", "RFID", "RFID_SCAN",
