...
private:
    const char *task_names[NUM_TASKS] = {
            ...
            "LOAD_DATA_COLLECTION", "READ_PERIPHERAL_INPUT", "SEND_PERIPHERAL_OUTPUT", "START_CONVEYOR", "STOP_CONVEYOR"
    };
    const char *feature_names[NUM_FEATURES] = {
            ...
            "RFID_MES_PACKAGE_GROUP_LIST", "RFID_BUYER_PO_LIST", "RFID_PO_DETAILS", "PACKAGE", "PACKAGE_DETAILS",
