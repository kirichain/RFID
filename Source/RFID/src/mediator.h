...
private:
    ...
    const char *feature_names[NUM_FEATURES] = {
            ...
            "RFID", "RFID_SCAN", "RFID_SCAN_HISTORY", "RFID_SCAN_RESULT", "RFID_MODIFY_TAG_DATA",
            "RFID_REGISTER_TAG", "RFID_REGISTER_TAG_SUCCESS", "RFID_REGISTER_TAG_FAILURE", "RFID_FACTORY_SELECT",
            "RFID_WEEK_SELECT", "RFID_PACKAGE_GROUPS_LIST", "RFID_MES_PACKAGES_LIST", "RFID_BUYER_PO_LIST",
