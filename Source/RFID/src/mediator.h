...
private:
    const char *task_names[NUM_TASKS] = {
            "IDLE", "BLINK_LED", "BLINK_SCREEN", "RECEIVE_COMMUNICATION_MESSAGE", "SEND_COMMUNICATION_MESSAGE",
            "INIT_MESSAGE_QUEUE", "CLEAR_MESSAGE_QUEUE", "PUBLISH_MQTT_MESSAGE", "SUBSCRIBE_MQTT_TOPIC",
            "RETRIEVE_MQTT_MESSAGE", "CONNECT_MQTT_BROKER", "HANDLE_MQTT_MESSAGE", "LOAD_CONFIG", "SAVE_CONFIG",
            "LOAD_FS", "SAVE_FS", "CHECK_CONNECTION", "INIT_AP_WIFI", "INIT_STA_WIFI", "TERMINATE_AP_WIFI",
            "TERMINATE_STA_WIFI", "SCAN_WIFI_NETWORKS", "GET_OPERATING_MODE", "SET_OPERATING_MODE", "RENDER_FEATURE",
            "GET_CURRENT_FEATURE", "READ_NAVIGATION_BUTTON", "INIT_NAVIGATION_BUTTON", "SET_CURRENT_FEATURE",
            "SET_TASK", "SET_TASK_STATUS", "GET_TASK_STATUS", "GET_RFID_SCAN_DATA", "IMPORT_DATA_FROM_SD_CARD",
