...
typedef struct {
    ...
    feature_t featureNavigationHistory[10];
    byte featureNavigationHistorySize;
    ...
    int mes_img_buffer_size;
    int mes_target;
    // For RFID
    bool is_the_first_scan;
    int current_scanned_rfid_tag_count;
    int current_matched_mes_scanned_rfid_tag_count;
    int registered_rfid_tags_from_server_count;
